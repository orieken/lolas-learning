...
export const useGameStore = defineStore('mathblast-game', {
  ...
  actions: {
    ...
    answerCorrect(points: number) {
      ...
      this.timerMax = calculateNextTimer(this.timerMax, true, this.consecutiveCorrect, this.consecutiveWrong);
    ...
    answerWrong() {
      ...
      this.timerMax = calculateNextTimer(this.timerMax, false, this.consecutiveCorrect, this.consecutiveWrong);
    },
